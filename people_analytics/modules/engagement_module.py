# ============================================
# modules/engagement_module.py — v2.0 | Engagement Index + PDF Export
# ============================================
...
def run_engagement_module():
    ...
    # --- Department Summary ---
    dept_summary = (
        df.groupby("Department", observed=True)["EngagementIndex"]
    ...
    cat_counts = (
        df["EngagementCategory"].value_counts()
    ...
    pie = px.pie(
        ...
        color_discrete_map={"High": "#16A34A", "Moderate": "#FACC15", "Low": "#DC2626"}
    )
    ...
    data_blocks = [
        {
            "title": "Engagement Index Summary",
            "desc": "Overall engagement distribution across departments and categories.",
            "df": dept_summary,
            "insights": [
                f"Overall engagement index: {overall_index:.2f}",
                f"Highest-engaged department: {dept_best}",
                f"High-engagement population: {(cat_counts['High']/cat_counts.sum())*100:.1f}%"
            ]
        },
        {
            "title": "Engagement Category Breakdown",
            "desc": "Distribution of Low, Moderate, and High engagement levels across the organization.",
            "df": pd.DataFrame({
            ...
            "insights": [
                ...
                f"Moderate-engagement share: {(cat_counts['Moderate']/cat_counts.sum())*100:.1f}%",
