...
| # | Project | Notebook | Highlight Results |
|---|---------|----------|-------------------|
...
| 3 | HR Data Cleaning Utility (Sidequest) | [HR_Data_Cleaning_Utility_V1.ipynb](sidequests/HR_Data_Cleaning_Utility_V1.ipynb) | Automated pipeline → `cleaned_hr_data.csv` |
